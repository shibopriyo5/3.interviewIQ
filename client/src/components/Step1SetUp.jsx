...
setAnalyzing(false);
    ...
    // setExperience logic likely follows here
  } catch (error) {
...
<select value={mode} onChange={(e)=>setMode(e.target.value)}  className="w-full py-3 px-4 border
...
outline-none transition">
    ...
    <option value="HR">HR Interview</option>
      ...
      {!analysisDone && (
  <motion.div whileHover={{scale:1.02}} onClick={()=>document.getElementById("resumeUpload").click()} className='border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-green-500 hover:bg-green-50 transition'>
  ...
  {resumeFile ? resumeFile.name : "Click to upload resume (Optional)"}
        ...
        {resumeFile && (
  <motion.button onClick={(e)=>{e.stopPropagation();handleUploadResume()}}
